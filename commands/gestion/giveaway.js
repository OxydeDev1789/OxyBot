			...
			if (args[0] === "reroll") {
				...
				function updateembed(msg) {
					...
					let menuoptions = [
						...
						{
							value: "Modifier la durée",
							description: "Permet de choisir la durée du giveaway",
							emoji: "🕙"
						},
						{
							value: "Modifier le salon",
							description: "Permet de choisir le salon",
							emoji: "🏷️"
						},
						{
						...
						{
							value: "Modifier le rôle obligatoire",
							description: "Permet de chosir le rôle pour participer au giveaway",
							emoji: "🌞"
						},
						{
							value: "Supprimer le rôle obligatoire",
							description: "Permet de supprimer le rôle obligatoire",
							emoji: "☀"
						},
						{
						...
						},
						{
							...
							description: "Permet de chosir la réaction du giveaway",
							emoji: "⭐"
						},
						{
							value: "Modifier le gain",
							description: "Permet de choisir le gain du giveaway",
							emoji: "🎁"
						},
