	...
	run: async (client, message, args, prefix, color) => {
		...
		function updateembed(msg) {
			...
			let menuoptions = [{
					...
					description: "Permet de configurer automatiquement le tempvoc",
					emoji: "🔰"
				},
				{
					value: "Modifier le salon vocal",
					description: "Permet de choisir le salon vocal",
					emoji: "🏷️"
				},
				{
					value: "Supprimer le salon vocal",
					description: "Permet de supprimer le salon vocal",
					emoji: "🛎️"
				},
				{
				...
				},
				{
					...
					description: "Permet de modifier l'émoji",
					emoji: "🌟"
				},
				{
