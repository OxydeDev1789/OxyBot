	...
	run: async (client, message, args, prefix, color) => {
		...
		function updateembed(msg) {
			if (db.get(`welcomestyle_${message.guild.id}_${message.id}`) === "message" || db.get(`welcomestyle_${message.guild.id}_${message.id}`) === null) {
				...
				let menuoptions = [{
						value: "Style Embed",
						description: "Permet d'envoyer votre message sous forme d'embed",
						emoji: "📑"
					},
					{
						value: "Modifier l'autorole",
						description: "Permet de choisir le rôle de bienvenue",
						emoji: "👤"
					},
					{
						value: "Supprimer l'autorole",
						description: "Permet de supprimer le rôle de bienvenue",
						emoji: "👥"
					},
					{
						value: "Modifier le salon de bienvenue",
						description: "Permet de choisir le salon de bienvenue",
						emoji: "🏷️"
					},
					{
						value: "Supprimer le salon de bienvenue",
						description: "Permet de supprimer le salon de bienvenue",
						emoji: "🛎️"
					},
					{
						value: "Modifier le message de bienvenue",
						description: "Permet de choisir le message de bienvenue",
						emoji: "📩"
					},
					{
						value: "Supprimer le message de bienvenue",
						description: "Permet de supprimer le message de bienvenue",
						emoji: "✉️"
					},
					{
						value: "Modifier le MP de bienvenue",
						description: "Permet de choisir le MP de bienvenue",
						emoji: "📫"
					},
					{
						value: "Supprimer le MP de bienvenue",
						description: "Permet de supprimer le MP de bienvenue",
						emoji: "📪"
					},
					{
						value: "Modifier le greet message",
						description: "Permet de choisir le greet de bienvenue",
						emoji: "🕙"
					},
					{
						value: "Supprimer le greet message",
						description: "Permet de supprimer le greet de bienvenue",
						emoji: "⏱"
					},
				...
				let menuoptions = [{
					...
					{
						value: "Modifier l'embed de bienvenue",
						description: "Permet de choisir l'embed de bienvenue",
						emoji: "📩"
					},
					{
						value: "Supprimer l'embed de bienvenue",
						description: "Permet de supprimer l'embed de bienvenue",
						emoji: "✉️"
					},
					{
						value: "Modifier le MP de bienvenue",
					...
					if (button.id === message.id + "welcomemsg") {
						...
						if (db.get(`joinmessageembed_${message.guild.id}`) !== null) {
							message.channel.send({
								embed: db.get(`joinmessageembed_${message.guild.id}`)
							})
						}
					}
