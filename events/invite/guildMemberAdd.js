...
module.exports = async (client, member) => {
	...
	if (db.get(`joinmessageembed_${member.guild.id}`) !== null) {
		...
		if (!embedj.description) {} else {
			embedj.description = embedj.description.replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv)
		}
		if (!embedj.title) {} else {
			embedj.title = embedj.title.replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv)
		}
		if (!embedj.footer) {} else {
			embedj.footer.text = embedj.footer.text.replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:name}", member.user.username).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:tag}", member.user.tag).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user:id}", member.user.id).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{user}", member.user).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter}", iv2).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:name}", iv2.username).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:tag}", iv2.tag).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{inviter:id}", iv2.id).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:name}", member.guild.name).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{guild:member}", member.guild.memberCount).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv).replace("{invite}", inv)
		}
		...
		if (welcomeChannel) welcomeChannel.send({
			...
			if (db.get(`joinmsgdel_${member.guild.id}`)) {
				msggg.delete({
					timeout: ms(db.get(`joinmsgdel_${member.guild.id}`))
				})
			}
		})
	} else {
